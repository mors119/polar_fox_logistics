function setupSystem() {
  ...
  try {
    const input = getOrCreateFolder_(
      CONFIG.properties.inputFolderId,
...
function ensureTrigger_() {
  ScriptApp.getProjectTriggers()
    .filter(trigger =>
      trigger.getHandlerFunction() === CONFIG.triggerHandler
    )
